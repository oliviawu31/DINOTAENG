...
class DB{
    protected $dsn="mysql:host=localhost;charset=utf8;dbname=dinotaeng";
    protected $pdo;
    protected $table;
    ...
    function min($col,$where=[]){
        return $this->math('min',$col,$shere); 
    }
...
function Q($sql){
    $pdo=new PDO("mysql:host=localhost;charset=utf8;dbname=dinotaeng",'root','');
